...
export const LovosisData = [
  {
    ...
    description:
      "We are the official distributor of UNV cameras and UNV CCTV systems in Dubai, providing you with direct access to the latest products and innovations",
    image: "/pictures/icons/icon2.png",
  },
  {
    title: "Wide Range of UNV CCTV Products",
    description:
      " Our product range includes everything from Uniview cameras to complete CCTV systems, ensuring that you find the perfect solution for your security needs.",
